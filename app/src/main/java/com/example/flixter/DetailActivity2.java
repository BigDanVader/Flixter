...
public class DetailActivity2 extends YouTubeBaseActivity {
    ...
    private static final String YOUTUBE_API_KEY = "AIzaSyCbtqI_cX2S572bwCX35obTJzwY1b1sYRA";
        ...
        client.get(String.format(VIDEO_URL, movie.getMovieId()), new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int i, Headers headers, JSON json) {
                try {
                    ...
                    Log.d("DetailActivity2", youTubeKey);
                    initializeYouTube(youTubeKey);
                } catch (JSONException e) {
                    Log.e("DetailActivity2", "failed to parse JSON", e);
                }
            }
    ...
    private void initializeYouTube(final String youTubeKey) {
        youTubePlayerView.initialize(YOUTUBE_API_KEY, new YouTubePlayer.OnInitializedListener() {
            ...
            public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
                Log.d("DetailActivity2", "onInitializationSuccess");
                youTubePlayer.cueVideo(youTubeKey);
            }

            @Override
            public void onInitializationFailure(YouTubePlayer.Provider provider, YouTubeInitializationResult youTubeInitializationResult) {
                Log.d("DetailActivity2", "onInitializationFailure");
            }
        });
    }
}